...
const button = cva(
  ...
  ],
  {
    variants: {
      variant: {
        filled: ['bg-brand', 'text-white', "hover:bg-[#2C2C2C]"],
				outlined: ['border border-black-100/10', 'text-[#1C1C1C]', 'hover:border-black-80'],
				gray: ['bg-black-100/5', 'text-black', 'hover:bg-black-100/10'],
